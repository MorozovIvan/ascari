...
<div class="form-group">
    ...
    <div class="col-sm-6"><input type="text" id="input-serial" value="<?php echo $serial; ?>" class="form-control" readonly="true" /></div>
</div>
<?php } ?>
<?php if (!empty($expires)){ ?>
<div class="form-group">
    <label class="col-sm-2 control-label" for="input-expires"><?php echo $addist_entry_expires; ?></label>
    <div class="col-sm-6"><input type="text" id="input-expires" value="<?php echo $expires; ?>" class="form-control" readonly="true" /></div>
</div>
<?php } ?>
<div class="form-group">
